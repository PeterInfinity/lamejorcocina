...
public abstract class GenericDaoImpl<T> implements GenericDao<T> {
	...
	public void delete(final Object id) {
		this.em.remove(this.em.getReference(entity, id));
	}

	@Override
	public T find(final Object id) {
		return (T) this.em.find(entity, id);
	}
	...
	@Override
	public List<T> findAll(final Map<String, Object> params, final Map<String, Object> orderParams) {
		StringBuffer getAllQuery = new StringBuffer(" from ").append(this.entity.getSimpleName());
		getAllQuery.append(getQueryClauses(params, orderParams));
		return em.createQuery(getAllQuery.toString()).getResultList();
	}
